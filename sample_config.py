...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Agora Api Scrapper Bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", " Agora Api Scrapper Bot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Agora_apibot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created by @Agora_Robots"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Agora_Robots")
